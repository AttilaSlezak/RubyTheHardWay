class Game
  ...
  def laser_weapon_armory()
    ...
    puts "You stand up an run to the far side of the room and find the"
  ...
  def escape_pod()
    ...
    puts "now need to pick ont to take. Some of them could be damaged"
	...
	cheat = 0
    loop {
	  loop {cheat = rand(5)+1; break if cheat != good_pod}
	  puts "The pod #%s is damaged." % cheat if guess == "cheat"
	  print "[pod #]>"
      guess = gets.chomp()
	  break if guess != "cheat" && 0 < guess.to_i && guess.to_i < 6
	}
